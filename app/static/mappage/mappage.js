...
// const $secondCourseImage = document.querySelector('.mappage__walkload__course2__img__img');
...
// 
//   courseImgLazyload(firstNearMark.image, secondNearMark.image)
// }
// 
// function courseImgLazyload(firstImgSrc, secondImgSrc) {
//   const $firstCourseWrap = document.querySelector(".mappage__walkload__course");
//   const $secondCourseWrap = document.querySelector(".mappage__walkload__course2");
//   $firstSourseImage.setAttribute("src", firstImgSrc);
//   $secondCourseImage.setAttribute("src", secondImgSrc);
//   new Promise(resolve => {
//     $firstSourseImage.onload = () => resolve(
